...
export const metadata = buildMetadata({
  title: "Products",
  description:
    "SiteMarketing.ai, SiteOptimization.ai, IranianCitizen.com, and PowerfulBlueprints.com — the ReTHINK CNERGY product portfolio.",
  path: "/products",
});
      ...
      <section className="pt-20 lg:pt-28">
        <Container>
          ...
          <p className="mt-8 max-w-2xl text-lg leading-relaxed text-ink-500 sm:text-xl">
            Four focused products under the ReTHINK CNERGY family. Each one solves a
