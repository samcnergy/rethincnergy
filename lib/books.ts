...
// Curated recommendations from Parham. Edit freely.
export const RECOMMENDED_BOOKS: RecommendedBook[] = [
  {
    ...
    author: "Jim Collins",
    year: "2009",
    why: "Five stages of decline that catch even great companies — and a hopeful argument that decline is largely self-inflicted and reversible. Required reading for anyone who has watched a competitor drift into Stage 3 without noticing.",
    topic: "Strategy",
  },
  {
    slug: "life-is-not-a-game-of-perfect",
    title: "Life is Not a Game of Perfect",
    author: "Dr. Bob Rotella with Bob Cullen",
    year: "1995",
    why: "A sports psychologist&rsquo;s account of performing under pressure that reads as cleanly for operators as it does for athletes. The chapters on real talent and where to put it are the ones we hand to clients.",
    topic: "Leadership",
  },
  {
    ...
    year: "2015",
    why: "The case for creating uncontested market space instead of fighting in red oceans. The frameworks here directly underpin how we think about positioning in client engagements.",
    topic: "Strategy",
  },
  {
    ...
    year: "2002",
    why: "A leadership fable that turned into the most-cited team-dynamics handbook in modern business. The trust → conflict → commitment → accountability → results pyramid is a workhorse on every leadership engagement we take on.",
    topic: "Leadership",
  },
  {
    ...
    year: "2013",
    why: "A clear-eyed guide to recognizing the work you should actually be doing. Pairs well with the strategic clarity our advisory engagements push for — at the personal level.",
    topic: "Leadership",
  },
];
